...
import { data1 } from './json/phqData';
...
const PhqManagement: React.FC = () => {
    ...
    const customMessage = () => <Empty className="p-2" description="No Questionnaire Available" />;
    const customLocale = {
    ...
    const columns= [
        ...
        },
        {
            ...
            // onFilter: (value: any, record: any) => record.questionnaire.toLowerCase().includes(value.toLowerCase()),
            // sorter: (a: any, b: any) => a.questionnaire.length - b.questionnaire.length,
        },
        {
            title: 'Description',
                    ...
                    <div className="d-flex justify-content-center action-section">
                        ...
                        <div className="fs-18 pointer my-auto">
                            <Popconfirm
                                ...
                                description="Delete the questionnaire"
                                onConfirm={() => {
    ...
    return (
        <div className="p-2">
            <div className="d-flex grid-title-card">
                <h5 className="my-auto ">Patient Health Questionnaire</h5>
