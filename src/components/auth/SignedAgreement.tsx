...
import { Image, message, Modal, Tooltip } from 'components/shared/AntComponent';
...
const SignedAgreement: React.FC<ChildProps> = ({ openModal, closeModal }) =>{
    const { loading3, acctInfo } = useSelector((state: any) => state.account);
    
    return(
        <div>
            <Modal title="Customer Agreement" open={openModal} width={'45%'} onCancel={closeModal} 
            cancelButtonProps={{
            ...
            >
                <div className="p-4 pt-0 customer-agreement">
                    {/* <Image src={EEGLogo} height="50px" preview={false}/> */}
                    <div className="mx-auto  mt-2 ">
                        {/* <div className="d-flex">
                            <h3 className="text- mb-3 ps-3 ms-auto">USER AGREEMENT</h3>
                        </div> */}

                        <div className="bg-light p-2 template-height" style={{ height: '350px', overflow: 'auto' }}>
                            <div>
                                <div className="d-flex mt-3">
                                    <Image src={EEGLogo} height={50} preview={false} />
                            ...
                            <div>
                                ...
                                {acctInfo?.agree_data?.acct_agreement_path && (
                                    <div className="mt-3 d-flex flex-column align-items-end mt-5 pt-5">    
                                        <h4 className="text-muted fs-18">Signature</h4>
                                        <Image
                                            src={acctInfo?.agree_data?.acct_agreement_path?.startsWith('https:') ?  acctInfo?.agree_data?.acct_agreement_path  : ''}
                                            height={50}
                                            preview={false}
                                        />
                                    </div>
